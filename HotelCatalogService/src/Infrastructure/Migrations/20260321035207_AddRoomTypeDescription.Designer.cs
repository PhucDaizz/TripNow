...
namespace HotelCatalogService.Infrastructure.Migrations
{
    ...
    [Migration("20260321035207_AddRoomTypeDescription")]
    partial class AddRoomTypeDescription
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HotelCatalogService.Domain.Entities.CancellationRule", b =>
                {
                    ...
                    b.HasIndex("CancellationPolicyId", "HoursBeforeCheckIn")
                        .IsUnique()
            ...
            modelBuilder.Entity("HotelCatalogService.Domain.Entities.Hotel", b =>
                {
                    ...
                    b.HasIndex("Status", "StartingPrice")
            ...
            modelBuilder.Entity("HotelCatalogService.Domain.Entities.PromotionUsage", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("HotelCatalogService.Domain.Entities.Room", b =>
                {
                    ...
                    b.Property<DateOnly?>("MaintenanceEnd")
                        .HasColumnType("date");

                    b.Property<DateOnly?>("MaintenanceStart")
                        .HasColumnType("date");
            ...
            modelBuilder.Entity("HotelCatalogService.Domain.Entities.PromotionUsage", b =>
                {
                    b.HasOne("HotelCatalogService.Domain.Entities.Promotion", null)
