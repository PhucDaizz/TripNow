        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Type = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    AvgRating = table.Column<decimal>(type: "decimal(3,1)", nullable: false, defaultValue: 0m),
                    IsVerify = table.Column<bool>(type: "tinyint(1)", nullable: false, defaultValue: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDeleted = table.Column<bool>(type: "tinyint(1)", nullable: false, defaultValue: false),
                    IsHidden = table.Column<bool>(type: "tinyint(1)", nullable: false, defaultValue: false),
                    HiddenReason = table.Column<string>(type: "varchar(255)", maxLength: 255, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PostLikes_PostId_UserId_Unique",
                table: "PostLikes",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reviews_PostId_Unique",
                table: "Reviews",
                column: "PostId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Reviews_Target_Performance",
                table: "Reviews",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SavedPosts_UserId_PostId_Unique",
                table: "SavedPosts",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserFollows_Target_Type",
                table: "UserFollows",
                columns: new[] { "TargetId", "Type" });

            migrationBuilder.CreateIndex(
                name: "IX_UserFollows_Unique_Constraint",
                table: "UserFollows",
                columns: new[] { "FollowerId", "TargetId", "Type" },
                unique: true);
        }
