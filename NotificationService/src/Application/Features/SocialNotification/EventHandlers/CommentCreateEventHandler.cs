...
{
    public class CommentCreateEventHandler : INotificationHandler<CommentCreateEvent>
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly INotificationService _notificationService;

        public CommentCreateEventHandler(IUnitOfWork unitOfWork, INotificationService notificationService)
        {
